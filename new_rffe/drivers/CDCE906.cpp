...
CDCE906::CDCE906(mbed::I2C * i2c, int8_t i2c_addr)
    : _i2c(i2c), _i2c_addr(i2c_addr)
{}


void CDCE906::cdce906_get_ssc(cdce906_cfg &cfg, const uint8_t * buff)
{
    uint8_t reg;
...
void CDCE906::cdce906_set_ssc(cdce906_cfg &cfg, uint8_t * buff)
{
    uint8_t reg;
...
void CDCE906::cdce906_get_pll_fvco(cdce906_cfg &cfg, const uint8_t * buff)
{
...
void CDCE906::cdce906_set_pll_fvco(cdce906_cfg &cfg, uint8_t * buff)
{
 ...
 void CDCE906::cdce906_get_pll_mux(cdce906_cfg &cfg, const uint8_t * buff)
{
...
void CDCE906::cdce906_set_pll_mux(cdce906_cfg &cfg, uint8_t * buff)
{
...
void CDCE906::cdce906_get_clksrc(cdce906_cfg &cfg,const uint8_t * buff)
{
...
void CDCE906::cdce906_set_clksrc(cdce906_cfg &cfg, uint8_t * buff)
{
    switch(cfg.clksrc)
    {
...
void CDCE906::cdce906_get_px_pll_sel(cdce906_cfg &cfg, const uint8_t * buff)
{
...
void CDCE906::cdce906_set_px_pll_sel(cdce906_cfg &cfg, uint8_t * buff)
{
...
void CDCE906::cdce906_set_pll_div(cdce906_cfg &cfg, uint8_t * buff)
{
...
void CDCE906::cdce906_get_pll_div(cdce906_cfg &cfg, const uint8_t * buff)
{
    const uint8_t div_m_low_byte[] = {CDCE906_PLL1_REF_DIV_M_LOW_BYTE, CDCE906_PLL2_REF_DIV_M_LOW_BYTE,
        CDCE906_PLL3_REF_DIV_M_LOW_BYTE};
    const uint8_t div_m_high_byte[] = {CDCE906_PLL1_REF_DIV_M_HIGH_BYTE, CDCE906_PLL2_REF_DIV_M_HIGH_BYTE,
...
void CDCE906::cdce906_set_yx_px_sel(cdce906_cfg &cfg, uint8_t * buff)
{
...
void CDCE906::cdce906_get_yx_px_sel(cdce906_cfg &cfg, const uint8_t * buff)
{
...
void CDCE906::cdce906_set_yx_slew(cdce906_cfg &cfg, uint8_t * buff)
{
...
void CDCE906::cdce906_get_yx_slew(cdce906_cfg &cfg, const uint8_t * buff)
{
    uint8_t yx_slew[6];
...
void CDCE906::cdce906_set_px_div(cdce906_cfg &cfg, uint8_t * buff)
{
...
void CDCE906::cdce906_get_px_div(cdce906_cfg &cfg, const uint8_t * buff)
{
    const uint8_t px_byte[] = {CDCE906_P0_DIV_BYTE, CDCE906_P1_DIV_BYTE, CDCE906_P2_DIV_BYTE,
        CDCE906_P3_DIV_BYTE, CDCE906_P4_DIV_BYTE, CDCE906_P5_DIV_BYTE};
    const uint8_t px_shift[] = {CDCE906_P0_DIV_SHIFT, CDCE906_P1_DIV_SHIFT, CDCE906_P2_DIV_SHIFT,
...
void CDCE906::cdce906_set_yx_out_cfg(cdce906_cfg &cfg, uint8_t * buff)
{
...
void CDCE906::cdce906_get_yx_out_cfg(cdce906_cfg &cfg, const uint8_t * buff)
{
    const uint8_t yx_en_byte[] = {CDCE906_Y0_EN_BYTE, CDCE906_Y1_EN_BYTE, CDCE906_Y2_EN_BYTE,
        CDCE906_Y3_EN_BYTE, CDCE906_Y4_EN_BYTE, CDCE906_Y5_EN_BYTE};
...
int CDCE906::cdce906_read_cfg(cdce906_cfg &cfg, uint8_t (&arr)[25])
{
    const char cmd = 0x00;
    int i2c_trans = 0;
    uint8_t data[27];

    i2c_trans = _i2c->write(_i2c_addr, &cmd, 1, true);
    if (i2c_trans != 0) {
        return -1;
    }

    i2c_trans = _i2c->read(_i2c_addr, reinterpret_cast<char*>(data), 27, false);
    if (i2c_trans != 0) {
        return -1;
    }
    ...
    memcpy(arr, &data[1], 25);

    return 0;
}

int CDCE906::cdce906_write_cfg(cdce906_cfg &cfg, uint8_t (&arr)[25])
{
    // uint8_t data[28] = {0, 25, 1}; // Write 25 bytes starting from
                                   // address 0
    uint8_t data[28] = {0x00, 25};
    ...
    i2c_trans = _i2c->write(_i2c_addr, tmp, 2, false);
    ...
    /*
     * Write to all _registers except for SSC
     */
    // i2c_trans = _i2c->write(_i2c_addr, reinterpret_cast<char*>(&data[3]), 25, false);
    i2c_trans = _i2c->write(_i2c_addr, reinterpret_cast<char*>(data), 27, false);
    if (i2c_trans != 0) {
        return -1;
    }
    memcpy(arr, &data[2], 25);

    return 0;
}

int CDCE906::cdce906_write_eeprom(cdce906_cfg &cfg)
{
    char data[2];
    int i2c_trans = 0;
    ...
    i2c_trans = _i2c->write(_i2c_addr, data, 2, true);
